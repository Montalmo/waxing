    ...
    <section className="py-xl bg-surface" id="about">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
        <div className="relative">
          ...
          <div className="absolute -bottom-6 -right-6 bg-white p-8 rounded-lg shadow-lg hidden lg:block">
            <p className="font-display-lg text-headline-lg text-primary">5+</p>
            <p className="text-label-sm text-secondary uppercase tracking-widest">Років досвіду</p>
          </div>
        </div>
        <div>
          <span className="text-label-sm text-secondary uppercase tracking-[0.3em] mb-4 block">Ваш майстер</span>
          <div className="relative mb-8 inline-block">
            <motion.h2 
              ...
              className="font-display-lg text-display-lg font-semibold text-primary"
            >
              Про майстра
            </motion.h2>
            <motion.span 
              ...
              className="absolute -bottom-2 left-0 w-full h-1 bg-primary/10 origin-left rounded-full"
            />
          </div>
