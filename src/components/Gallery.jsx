...
const Gallery = () => {
  ...
  return (
    <section className="py-12 xs:py-xl bg-white overflow-hidden" id="gallery">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <SectionHeading className="mb-10 xs:mb-16">Галерея</SectionHeading>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 xs:gap-3 md:gap-4">
          ...
          <div className="space-y-2 xs:space-y-3 md:space-y-4 md:pt-8">
          ...
          <div className="space-y-2 xs:space-y-3 md:space-y-4 md:pt-12">
